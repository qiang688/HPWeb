<template>
  <el-dialog title="查询条件" :visible.sync="dialogFormVisible">
    <el-form :model="form" size="mini" :label-width="formLabelWidth">
        ...
        <el-input v-model="form.report_no"></el-input>
      </el-form-item>
      <el-form-item label="报表名称">
        <el-input v-model="form.report_name"></el-input>
      </el-form-item>
      <el-form-item label="报表模板">
        <el-input v-model="form.view_template"></el-input>
      </el-form-item>
      <el-form-item label="报表样式">
        <el-input v-model="form.report_css"></el-input>
      </el-form-item>
